...
namespace 扑克牌
{
	partial class helpform
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "\r\n          3.你最多可以拥有十张牌，当你手中的牌点数等于目标点时，请按\r\n下”OH!YE!“的按钮，你将获得等同于剩余牌堆数+对局数x10的分数。之" +
			"后\r\n将进行洗牌，开始下一局游戏。\r\n\r\n            \r\n";
			// 
			// label2
			// 
			...
			this.label3.Text = "          4.手中点数不为目标点却点击了\"OH!YE!“的按钮，将扣除10点分\r\n数。剩余牌堆为零时，继续抽牌将结束本局游戏，开启下一局游戏，且\r\n扣除" +
			"20点分数。点击重新洗牌将扣除50点分数。当你凑够目标点点点\r\n击“OH!YE!“后，若你手中有大王+50点分数，小王+30点分数。\r\n\r\n          " +
			"  \r\n";
			// 
			// label4
			// 
			...
			this.label5.Size = new System.Drawing.Size(562, 59);
			this.label5.TabIndex = 5;
			this.label5.Text = "          5.当你抽牌后手牌总点数超过目标点，你将被扣除你手中\r\n当前点数与目标点的差的三倍的点数。当你分数小于等于-250\r\n时游戏结束。\r\n    " +
			"        \r\n";
			// 
			// label6
			// 
